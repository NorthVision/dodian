...
public abstract class Player extends Constants{
	public long lastDeath = 0, lastAction = 0, lastClick = 0;
	public int hits = 0, fightId = 0, npcId2 = 0;
	public boolean fighting = false;
	public int tradeId = -1, dbId = -1, violations = 0;
	public boolean premium = false, randomed = false;
	public int rating = 1500, matchId = -1, matchLives = 2, loginReturn = 11, playerGroup = 3, deathNum = 0, uid = -1, playerTicks = 100;
...
*/
	...
	protected void appendPlayerAppearance(stream str)
	{
		...
		playerProps.writeByte(pGender);		// player sex. 0=Male and 1=Female
		playerProps.writeByte(headIcon);		// playerStatusMask - skull, prayers etc alkup 0
	...
	public void appendPlayerUpdateBlock(stream str) {
		...
		if(plrTextUpdateRequired) updateMask |= 4;
		if(updateMask >= 0x100) {
		...
		if(plrTextUpdateRequired) appendString4(str);
