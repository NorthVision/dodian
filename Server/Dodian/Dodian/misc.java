...
import java.text.*;
public class misc {
	public static String[] rules = {"Offensive language", "Item scamming", "Password scamming", "Bug abuse (includes noclip)", "Dodian staff impersonation", "Monster luring or abuse", "Macroing", "Item Duplication",
				"Encouraging others to break rules", "Misuse of yell channel", "Advertising / website", "Possible duped items"};
	public static int[] times = {1, 3, 3, 1, 5, 1, 0, 0, 0, 1, 1, 0, 0};
	public static int[] buttons_smelting = {15147, 15146, 10247, 9110, 15151, 15150, 15149, 15148, 15155, 15154, 15153, 15152, 15159, 15158, 15157, 
						15156, 15163, 15162, 15161, 15160, 29017, 29016, 24253, 16062, 29022, 29020, 29019, 29018, 29026, 29025, 29024, 29023};
	public static int[] smelt_frame = {2405, 2406, 2407, 2409, 2410, 2411, 2412, 2413};
	public static int[] smelt_bars = {2349, 2351, 2355, 2353, 2357, 2359, 2361, 2363};
